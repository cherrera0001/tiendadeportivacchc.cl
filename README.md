...
- [`spec.md`](spec.md) — qué se construye y en qué orden (M0–M6)
- [`CLAUDE.md`](CLAUDE.md) — protocolo para agentes
- [`data.md`](data.md) — modelo, contratos, eventos, KPIs
...
Cloudflare queda para DNS, CDN, R2 y WAF cuando exista el dominio. GitHub es el remoto: `cherrera0001/tiendadeportivacchc.cl`.
